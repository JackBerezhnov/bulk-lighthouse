      ...
      <form onSubmit={handleSubmit} className="mb-8">
        <div className="space-y-4">
          ...
          <div className="flex justify-center">
              ...
              type="submit"
              disabled={loading}
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg flex items-center gap-2 min-w-[140px] justify-center font-medium"
            >
              {loading ? (
                <>
                ...
                <>
                  ...
                  <span>Analyze {strategy === 'mobile' ? 'Mobile' : 'Desktop'}</span>
                </>
              )}
            </button>
          </div>
